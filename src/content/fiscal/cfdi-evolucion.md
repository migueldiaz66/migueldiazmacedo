...
Entender esa lógica —qué carencia resolvía cada etapa y cómo cada una preparó la siguiente— es lo que permite anticipar hacia dónde sigue. La siguiente entrega de esta serie reconstruye [el ciclo de vida del CFDI 4.0](https://migueldiazmacedo.com/fiscal/cfdi-ciclo-de-vida/) —tipos, actores, procesos y estados—; las que siguen abordan los retos que este modelo plantea hoy, tanto para la autoridad como para quienes emiten facturas.
